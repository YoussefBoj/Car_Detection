...
def extract_code_from_folder(root_path, output_file='extracted_code.txt'):
    ...
    code_extensions = {
        '.py','.env', '.yml', '.yaml', '.json', '.js', '.jsx','.ts', '.tsx', '.txt'
    }
    
    # Files/folders to exclude
    exclude_dirs = {'node_modules', '.git', 'dist', 'build', '__pycache__', 'rag_venv', '.venv', '.next', 'ai_autoexpert_env'}
    exclude_files = {
        'package-lock.json', '.DS_Store',
        'extract_code.py', 'project_structure.txt',
        'rag_requirements.txt', 'structure.py', 
...
if __name__ == "__main__":
    ...
    project_path = r"C:\Users\youss\Downloads\Documents\Stages+Projects\Projects 2 eme\p2m_modified2"
